...
export const styles = {
  ...
  button:
    'text-gray-300 border border-gray-300 px-4 p-2 rounded w-full text-left text-sm overflow-hidden whitespace-nowrap text-overflow-ellipsis dark:bg-gray-700 dark:border-gray-600',
  openDiv:
